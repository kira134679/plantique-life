  ...
  return (
    <>
      <div className="container py-13">
        <h2 className="h3 mb-8">更改優惠券</h2>
        <form>
          <section className="py-6">
            <h3 className="h4 mb-6">基本設定</h3>
            <div className="mb-6 w-50 min-w-14rem">
              <label className="form-label text-neutral-700 fs-7" htmlFor="update-coupon-code">
                折扣碼<span className="text-danger">*</span>
              </label>
              <input id="update-coupon-code" className="form-control" type="text" placeholder="請輸入優惠券折扣碼" />
            </div>
            <div className="mb-6 w-50 min-w-14rem">
              <label className="form-label text-neutral-700 fs-7" htmlFor="update-coupon-title">
                名稱<span className="text-danger">*</span>
              </label>
              <input id="update-coupon-title" className="form-control" type="text" placeholder="請輸入優惠券名稱" />
            </div>
            <div className="mb-6 w-25 min-w-14rem">
              <label className="form-label text-neutral-700 fs-7" htmlFor="update-coupon-status">
            ...
            <div className="mb-6 w-25 min-w-14rem">
              <label className="form-label text-neutral-700 fs-7" htmlFor="update-coupon-discount">
                折扣<span className="text-danger">*</span>
              </label>
              <div className="input-group">
                <input id="update-coupon-discount" className="form-control" type="number" placeholder="請輸入折扣" />
